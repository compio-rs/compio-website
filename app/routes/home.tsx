...
export function meta({ }: Route.MetaArgs) {
  return [
    { title: 'Compio' },
    { name: 'compio', content: 'Compio async runtime' },
  ];
}
  ...
  return (
    <HomeLayout {...baseOptions()}>
      <Container>
        <FadeIn.Container
          className={cx(
            'grow min-h-[75lvh] pt-[clamp(10rem,25lvh,30rem)]',
        ...
        >
          <motion.h1
            ...
            className={cx(
              ...
              'text-6xl',
              'bg-blue-300/50 text-neutral-600 font-black leading-normal md:leading-snug',
            )}
          >
